  ...
  const [polls, setPolls] = useState<Poll[]>([
    {
      ...
      description: "Help us decide which community project to prioritize this quarter",
      type: "poll",
      status: "open",
      visibility: "public",
      ...
      accountOnlySubmissions: false,
      ipLock: false,
      deviceLock: false,
      blockTabSwitching: false,
      requiresApproval: false,
      editPermissions: ["admin"],
      viewResultsPermissions: ["admin", "officer"],
      theme: {
        primaryColor: "#f6421f",
      ...
      responses: 45,
      views: 120,
      shareLink: "https://ysp-tagum.org/poll/POLL-001",
    },
    {
      id: "EVAL-001",
      title: "Tree Planting Event Evaluation",
      description: "Please share your feedback on our recent tree planting activity",
      type: "evaluation",
      status: "open",
      visibility: "private",
      ...
      accountOnlySubmissions: true,
      ipLock: false,
      deviceLock: false,
      blockTabSwitching: false,
      requiresApproval: true,
      editPermissions: ["admin", "officer"],
      viewResultsPermissions: ["admin", "officer", "auditor"],
      theme: {
        primaryColor: "#10b981",
        backgroundColor: "#ffffff",
    ...
    {
      id: "SURVEY-001",
      title: "Member Satisfaction Survey 2025",
      description: "Annual survey to gather feedback on YSP activities and initiatives",
      type: "survey",
      status: "open",
      visibility: "private",
      ...
      requiresApproval: false,
      editPermissions: ["admin"],
      viewResultsPermissions: ["admin", "auditor"],
      theme: {
        primaryColor: "#3b82f6",
        backgroundColor: "#ffffff",
    ...
    {
      id: "ASSESS-001",
      title: "Officer Performance Assessment",
      description: "Confidential assessment for committee heads and officers",
      type: "assessment",
      status: "open",
      visibility: "private",
      createdBy: "Juan Dela Cruz",
    ...
    },
    {
      ...
      description: "Register for the upcoming Youth Leadership Summit",
      type: "form",
      status: "open",
      visibility: "public",
      createdBy: "Maria Santos",
