...
import { Mail, Facebook, X, Loader2, Plus, Upload, Trash2, ExternalLink } from 'lucide-react';
              ...
              >
                ...
                >
                  ...
                  <div className="p-4 bg-white dark:bg-gray-800">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2 whitespace-normal break-words break-all">{renderLinkifiedText(project.description)}</p>
                  </div>
                </div>
                {isAdminOrAuditor && (
      ...
      {selectedProject && (
        <div className="modal-overlay" onClick={() => setSelectedProject(null)}>
          <div ref={modalContentRef} className="modal-content max-w-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-justify whitespace-normal break-words break-all">{renderLinkifiedText(selectedProject.description)}</p>
          </div>
        </div>
      )}
